...
-- Current schema (docs/3.4-*, docs/6-file-storage-section-done.md).
...
-- projects domain — not yet migrated to the layered architecture (docs/3.2-3.5-*.md).
...
-- CREATE TYPE (see database/psql/models/{file,work}.py for the source enums).
