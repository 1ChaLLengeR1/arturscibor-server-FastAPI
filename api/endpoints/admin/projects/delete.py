...
from api.endpoints.urls import ADMIN_PROJECTS_DELETE
...
from core.handler.projects.delete import handler_delete_project
...
@router.delete(
    ...
    summary="[Admin] Delete a project (and its attached images)",
...
def api_admin_delete_project(
    ...
    try:
        _, error, ok = handler_delete_project(project_id, db_session=db)
        if not ok:
        ...
        error = ApiErrorData(
            message=str(e),
            type_module="api_admin_delete_project",
