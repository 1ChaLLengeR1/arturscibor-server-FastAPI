...
from core.handler.work.items.delete import handler_delete_work_item
...
@router.delete(
    ...
    summary="[Admin] Delete a work item",
...
def api_admin_delete_work_item(
    work_id: str,
    item_id: str,
    ...
    try:
        _, error, ok = handler_delete_work_item(work_id, item_id, db_session=db)
        if not ok:
        ...
        error = ApiErrorData(
            message=str(e),
            type_module="api_admin_delete_work_item",
