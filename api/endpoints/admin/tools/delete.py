...
@router.delete(
    ADMIN_TOOLS_DELETE,
    summary="[Admin] Delete a tool (and its attached images)",
...
def api_admin_delete_tool(
    ...
    try:
        ...
        error = ApiErrorData(
            message=str(e), type_module="api_admin_delete_tool", type_error="exception", key_type_error="Exception"
        )
